...
export default function CreateCompanyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ submit: 'Failed to create company' });
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-4xl mx-auto px-8 py-10">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">Add a new company to your portfolio</p>
          </div>
        </div>
        ...
        {success && (
          <div className="mb-6 p-4 bg-emerald-50 border-l-4 border-emerald-500 rounded-r-xl flex items-center gap-3">
            ...
            <p className="text-emerald-800 font-medium">Company created successfully! Redirecting...</p>
          </div>
        )}
